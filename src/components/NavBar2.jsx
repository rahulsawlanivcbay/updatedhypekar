...
export default function NavBar2() {
  ...
  const getLogout = async () => {
    await axios
      .get("https://apihypekar.herokuapp.com/logout/")
            ...
            <Link to="/">
              <Box>
                <Image
                  borderRadius={10}
                  w="100px"
                  src="https://stimg.cardekho.com/images/carexteriorimages/630x420/Tata/Nexon/7384/1614326304397/front-left-side-47.jpg?impolicy=resize&imwidth=480"
                ></Image>
              </Box>
            </Link>
