...
export default function UserDetails() {
  ...
  const { email, setEmail, userCarDetails, userDetails } =
      ...
      <SimpleGrid>
        <Stack h="500px">
          <Box as={"header"}>
            ...
            >
              Welcome to HypeKar {userDetails.first_name}{" "}
          ...
          >
            ...
            <Box>
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
                <List fontFamily={"Oswald"} spacing={2}>
            ...
            <Box>
              ...
              {userCarDetails.length > 0 ? (
                userCarDetails.map((e) => (
                  <>
                    <List fontFamily={"Oswald"} spacing={2}>
                      <ListItem>BRAND : {e.brand}</ListItem>
                    </List>
                    <List fontFamily={"Oswald"} spacing={2}>
                      <ListItem>MODEL {e.model_Name}</ListItem>
                    </List>
                  </>
                ))
              ) : (
