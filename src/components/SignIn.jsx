...
export default function SignIn() {
  ...
  const { email, setEmail, userDetails, setUserDetails } =
  ...
  const loginUser = async () => {
    if (isNullish == true) {
      ...
      await axios
        .post("https://hypekar-backend.herokuapp.com/login/", text)
        .then((Response) => {
          ...
          >
            <FormControl id="userName">
              <Stack direction={["column", "row"]} spacing={6}>
                <Center>
                  <Avatar size="xl" src={logo} className="obj_contain">
                    <AvatarBadge
                      as={IconButton}
                      size="sm"
                      rounded="full"
                ...
                <Center w="full">
                  <Heading w="full" fontFamily={"AUDIOWIDE"}>
                    User Login
                  </Heading>
                </Center>
              </Stack>
            ...
            <FormControl id="username" isRequired>
              <FormLabel fontFamily={"Oswald"}>User name</FormLabel>
              <Input
            ...
            <FormControl id="password" isRequired>
              <FormLabel fontFamily={"Oswald"}>Password</FormLabel>
              <Input
                onChange={handleSubmit}
            ...
            <Text fontFamily={"Oswald"}>new user?</Text>
            <Link to="/signup">
              <Text
                _hover={{ fontWeight: "semibold", color: "blue" }}
                fontFamily={"Oswald"}
              >
