...
export default function Testimonals() {
  return (
    <div className="oswald" style={{ marginBottom: "40px" }}>
      <Carousel
        showArrows={true}
        infiniteLoop={true}
        showThumbs={false}
        ...
        <div>
          ...
          <div className="myCarousel">
            ...
            <div>
              <span class="fa fa-map-marker"></span>
              <h4>
                <span>Feedback From:</span> mumbai
              </h4>
            </div>
