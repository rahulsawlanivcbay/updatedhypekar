  ...
  return (
    <>
      ...
      >
        ...
        <div className="oswald mb-4">
          <Heading size="m" fontFamily={"oswald"} className="mt-4 mb-2">
            {" "}
            Introduction
          </Heading>
          Welcome to Hypekar Private Limited (“Company”, “we”, “our”, “us”)!
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at hypekar.com (together or individually
          “Service”) operated by Hypekar Private Limited. Our Privacy Policy
          ...
          <a
            href="mailto:info.hypekar@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
            info.hypekar@gmail.com
          </a>{" "}
          ...
          address, and your shipping information. You represent and warrant
          ...
          information you supply to us is true, correct and complete. We may
          employ the use of third party services for the purpose of facilitating
          ...
          it or Hypekar Private Limited cancels it. You may cancel your
          ...
          customer support team. A valid payment method is required to process
          the payment for your subscription. You shall provide Hypekar Private
          ...
          Hypekar Private Limited to charge all Subscription fees incurred
          through your account to any such payment instruments. Should automatic
          billing fail to occur for any reason, Hypekar Private Limited reserves
          the right to terminate your access to the Service with immediate
          effect.
          <Heading size="m" fontFamily={"oswald"} className="mt-4 mb-2">
            6. Free Trial
          </Heading>
          Hypekar Private Limited may, at its sole discretion, offer a
          ...
          information when signing up for Free Trial, you will not be charged by
          Hypekar Private Limited until Free Trial has expired. On the last day
          of Free Trial period, unless you cancelled your Subscription, you will
          ...
          Hypekar Private Limited reserves the right to (i) modify Terms of
          Service of Free Trial offer, or (ii) cancel such Free Trial offer.
          <Heading size="m" fontFamily={"oswald"} className="mt-4 mb-2">
            7. Fee Changes
          </Heading>
          Hypekar Private Limited, in its sole discretion and at any time, may
          ...
          Cycle. Hypekar Private Limited will provide you with a reasonable
          ...
          effective. Your continued use of Service after Subscription fee change
          ...
          Content found on or through this Service are the property of Hypekar
          Private Limited or used with permission. You may not distribute,
          ...
          Terms. You agree not to use Service: 0.1. In any way that violates any
          applicable national or international law or regulation. 0.2. For the
          ...
          otherwise. 0.3. To transmit, or procure the sending of, any
          advertising or promotional material, including any “junk mail”, “chain
          letter,” “spam,” or any other similar solicitation. 0.4. To
          ...
          unlawful, illegal, fraudulent, or harmful purpose or activity. 0.6. To
          ...
          Additionally, you agree not to: 0.1. Use Service in any manner that
          ...
          real time activities through Service. 0.2. Use any robot, spider, or
          other automatic device, process, or means to access Service for any
          ...
          material on Service or for any other unauthorized purpose without our
          prior written consent. 0.4. Use any device, software, or routine that
          ...
          malicious or technologically harmful. 0.6. Attempt to gain
          ...
          computer, or database connected to Service. 0.7. Attack Service via a
          denial-of-service attack or a distributed denial-of-service attack.
          0.8. Take any action that may damage or falsify Company rating. 0.9.
          ...
          property of Hypekar Private Limited and its licensors. Service is
          ...
          product or service without the prior written consent of Hypekar
          Private Limited.
          <Heading size="m" fontFamily={"oswald"} className="mt-4 mb-2">
            15. Copyright Policy
          </Heading>
          ...
          Claims” You may be held accountable for damages (including costs and
          ...
          detail): 0.1. an electronic or physical signature of the person
          ...
          where the material that you claim is infringing is located; 0.4. your
          address, telephone number, and email address; 0.5. a statement by you
          ...
          that are not owned or controlled by Hypekar Private Limited. Hypekar
          Private Limited has no control over, and assumes no responsibility for
          ...
          are binding on you. By continuing to access or use our Service after
          ...
          of such right or provision. If any provision of Terms is held by a
